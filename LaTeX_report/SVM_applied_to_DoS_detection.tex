...
\tableofcontents
% We need a new page or otherwise the table of contents won't fit...
\newpage
...
\section{Troubleshooting}
	...
	\begin{figure}
		\centering
		\includegraphics[scale = 1]{mn_clean.png}
		\label{f:mn_clean}
	\end{figure}
