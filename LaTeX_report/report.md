...
![scenario](../img/scenario.png "Mininet's Scenario")
...
![limits](../img/scenario_limits.png "Scenario with link capacities")
...
![dos_atk](../img/scenario_ddos.png "Under attack!")
...
[![yt_thumb](../img/yt_thumbnail.jpg)](https://www.youtube.com/watch?v=ofZPmV6_y_M)
...
![telegraf_bypass](../img/telegraf_connections.png "Bypassing through the filesystem")
...
![svm_graph](../img/svm_graph.png "SVM decision regions")
...
![dump](../img/dump.png "The dump command")
...
![xterm](../img/xterm.png "Launching Xterm on the nodes")
...
![intfs](../img/initfs_cmd.png "The ports and initfs commands")
